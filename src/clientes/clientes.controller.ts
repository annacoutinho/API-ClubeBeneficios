...
export class ClientesController {
  ...
  @Get()
  async listarClientes(@GetUsuario() usuario: { tipoUsuario: TipoUsuario }): Promise<Cliente[]> {
    return this.clientesService.findAll(usuario.tipoUsuario)
  }

  @Post()
  async cadastrarCliente(@Body() dados: CreateClienteDto): Promise<Cliente> {
    return this.clientesService.create(dados)
  }
}
